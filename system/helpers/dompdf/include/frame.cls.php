...
class Frame {
  ...
  function get_containing_block($i = null) {
    if ( isset($i) ) {
      return (float)$this->_containing_block[$i];  
    }  
  ...
  function get_padding_box() {
    ...
    $x = (float)$this->_position["x"] +
      (float)$style->length_in_pt(array($style->margin_left,
                                 $style->border_left_width),
                           $cb["w"]);
                           
    $y = (float)$this->_position["y"] +
      (float)$style->length_in_pt(array($style->margin_top,
                                 $style->border_top_width),
                           $cb["h"]);
    
    $w = (float)$style->length_in_pt(array($style->padding_left,
                                    $style->width,
                                    $style->padding_right),
                              $cb["w"]);

    $h = (float)$style->length_in_pt(array($style->padding_top,
                                    $style->height,
                                    $style->padding_bottom),
                             $cb["h"]);
  ...
  function get_border_box() {
    ...
    $x = (float)$this->_position["x"] + (float)$style->length_in_pt($style->margin_left, $cb["w"]);
                          
    $y = (float)$this->_position["y"] + (float)$style->length_in_pt($style->margin_top,  $cb["h"]);

    $w = (float)$style->length_in_pt(array($style->border_left_width,
                                    $style->padding_left,
                                    $style->width,
                                    $style->padding_right,
                                    $style->border_right_width),
    ...
    $h = (float)$style->length_in_pt(array($style->border_top_width,
                                    $style->padding_top,
                                    $style->height,
                                    $style->padding_bottom,
                                    $style->border_bottom_width),
  ...
  function set_containing_block($x = null, $y = null, $w = null, $h = null) {
    ...
    if (is_numeric($x)) {
      $this->_containing_block["x"] = (float)$x;
    }
    
    if (is_numeric($y)) {
      $this->_containing_block["y"] = (float)$y;
    }
    
    if (is_numeric($w)) {
      $this->_containing_block["w"] = (float)$w;
    }
    
    if (is_numeric($h)) {
      $this->_containing_block["h"] = (float)$h;
    }
  }
