...
class Reports extends General{
	...
	public function daily_sales(){
		...
		if(isset($_POST['btnView'])){
			...
			if($this->input->post('cType') == "browser"){
				$this->audit_report_generation('financial', 'daily_sales', 'browser');
				$this->load->view('app/reports_result/daily_sales',$this->data);	
			}else{
				$this->audit_report_generation('financial', 'daily_sales', 'pdf');
	...
	public function patient_visited(){
		if(isset($_POST['btnView'])){
			...
			if($this->input->post('cType') == "browser"){
				$this->audit_report_generation('opd', 'patient_visited', 'browser');
				$this->load->view('app/reports/patient_visited_result',$this->data);	
			}else{
				$this->audit_report_generation('opd', 'patient_visited', 'pdf');
				$this->load->helper('file');
        		$this->load->helper('dompdf');  
	...
	public function outpatient(){
		if(isset($_POST['btnView'])){
			...
			if($this->input->post('cType') == "browser"){
				$this->audit_report_generation('opd', 'outpatient', 'browser');
				$this->load->view('app/reports_result/outpatient',$this->data);	
			}else{
				$this->audit_report_generation('opd', 'outpatient', 'pdf');
				$this->load->helper('file');
        		$this->load->helper('dompdf');  
    ...
    public function inpatient(){
        if(isset($_POST['btnView'])){
			...
			if($this->input->post('cType') == "browser"){
				$this->audit_report_generation('opd', 'inpatient', 'browser');
				$this->load->view('app/reports_result/inpatient',$this->data);
			}else{
				$this->audit_report_generation('opd', 'inpatient', 'pdf');
				$this->load->helper('file');
        		$this->load->helper('dompdf');  
	...
	public function discharged_patient(){
		if(isset($_POST['btnView'])){
			...
			if($this->input->post('cType') == "browser"){
				$this->audit_report_generation('opd', 'discharged_patient', 'browser');
				$this->load->view('app/reports_result/discharged_patient',$this->data);	
			}else{
				$this->audit_report_generation('opd', 'discharged_patient', 'pdf');
				$this->load->helper('file');
        		$this->load->helper('dompdf');  
	...
	public function declared_receipt(){
		if(isset($_POST['btnView'])){
			...
			if($this->input->post('cType') == "browser"){
				$this->audit_report_generation('financial', 'declared_receipt', 'browser');
				$this->load->view('app/reports_result/declared_receipt',$this->data);	
			}else{
				$this->audit_report_generation('financial', 'declared_receipt', 'pdf');
				$this->load->helper('file');
        		$this->load->helper('dompdf');  
	...
	public function doctorFeeReport(){
		if(isset($_POST['btnView'])){
			...
			if($this->input->post('cType') == "browser"){
				$this->audit_report_generation('financial', 'doctor_fee_report', 'browser');
				$this->load->view('app/reports_result/doctor_fee_report',$this->data);	
			}else{
				$this->audit_report_generation('financial', 'doctor_fee_report', 'pdf');
				$this->load->helper('file');
        		$this->load->helper('dompdf');  
