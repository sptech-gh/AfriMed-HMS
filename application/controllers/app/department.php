...
class Department extends General{
	...
	public function department($offset = 0){
		...
		{	
				$deleteForm = '<form method="post" action="'.base_url().'app/department/delete/'.$department->department_id.'" style="display:inline;" onsubmit="return confirm(\'Are you sure want to delete?\')">'
