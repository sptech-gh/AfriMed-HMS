...
class Diagnosis extends General{
	...
	public function diagnosis($offset = 0){
		...
		{	
				$deleteForm = '<form method="post" action="'.base_url().'app/diagnosis/delete/'.$diagnosis->diagnosis_id.'" style="display:inline;" onsubmit="return confirm(\'Are you sure want to delete?\')">'
