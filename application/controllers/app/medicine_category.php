...
class Medicine_category extends General{
	...
	public function medicine_category($offset = 0){
		...
		{	
				...
				$deleteForm = '<form method="post" action="'.base_url().'app/medicine_category/delete/'.$category->cat_id.'" style="display:inline;" onsubmit="return confirm(\'Are you sure want to delete?\')">'
