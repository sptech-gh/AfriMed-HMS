...
class Room_bed extends General{
	...
	public function room_bed($offset = 0){
		...
		{	
				$deleteForm = '<form method="post" action="'.base_url().'app/room_bed/delete/'.$category->room_bed_id.'" style="display:inline;" onsubmit="return confirm(\'Are you sure want to delete?\')">'
