...
class Complain extends General{
	...
	public function complain($offset = 0){
		...
		{	
				$deleteForm = '<form method="post" action="'.base_url().'app/complain/delete/'.$complain->complain_id.'" style="display:inline;" onsubmit="return confirm(\'Are you sure want to delete?\')">'
