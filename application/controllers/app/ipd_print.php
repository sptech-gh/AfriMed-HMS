...
class Ipd_print extends General{
	...
	public function __construct(){
		...
		General::variable();
		require_role(array('doctor', 'cashier'));
		if (!isset($this->data['companyInfo']) || !$this->data['companyInfo']) {
			$this->data['companyInfo'] = $this->general_model->companyInfo();
		}
	}

	private function require_ipd_print_access($report_key, $format){
		$this->require_report_scope('clinical');
		$this->audit_report_generation('clinical', (string)$report_key, (string)$format);
	}
	
	public function print_diagnosis(){
		$this->require_ipd_print_access('ipd_print_diagnosis', 'browser');
	...
	public function pdf_diagnosis(){
		$this->require_ipd_print_access('ipd_print_diagnosis', 'pdf');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function print_medication(){
		$this->require_ipd_print_access('ipd_print_medication', 'browser');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function pdf_medication(){
		$this->require_ipd_print_access('ipd_print_medication', 'pdf');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function print_complain(){
		$this->require_ipd_print_access('ipd_print_complain', 'browser');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function pdf_complain(){
		$this->require_ipd_print_access('ipd_print_complain', 'pdf');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function print_progress_note(){
		$this->require_ipd_print_access('ipd_print_progress_note', 'browser');
		$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function pdf_progress_note(){
		$this->require_ipd_print_access('ipd_print_progress_note', 'pdf');
			$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function print_intake(){
		$this->require_ipd_print_access('ipd_print_intake', 'browser');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function pdf_intake(){
		$this->require_ipd_print_access('ipd_print_intake', 'pdf');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function print_output(){
		$this->require_ipd_print_access('ipd_print_output', 'browser');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function pdf_output(){
		$this->require_ipd_print_access('ipd_print_output', 'pdf');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function print_nurse_note(){
		$this->require_ipd_print_access('ipd_print_nurse_note', 'browser');
		$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function pdf_nurse_note(){
		$this->require_ipd_print_access('ipd_print_nurse_note', 'pdf');
		$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function print_vital(){
		$this->require_ipd_print_access('ipd_print_vital', 'browser');
		$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function pdf_vital(){
		$this->require_ipd_print_access('ipd_print_vital', 'pdf');
		$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function print_room_transfer(){
		$this->require_ipd_print_access('ipd_print_room_transfer', 'browser');
		$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function pdf_room_transfer(){
		$this->require_ipd_print_access('ipd_print_room_transfer', 'pdf');
		$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function print_operation_theater(){
		$this->require_ipd_print_access('ipd_print_operation_theater', 'browser');
			$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function pdf_operation_theater(){
		$this->require_ipd_print_access('ipd_print_operation_theater', 'pdf');
			$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function print_patient_history(){
		$this->require_ipd_print_access('ipd_print_patient_history', 'browser');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function pdf_patient_history(){
		$this->require_ipd_print_access('ipd_print_patient_history', 'pdf');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function print_discharge_summary(){
		$this->require_ipd_print_access('ipd_print_discharge_summary', 'browser');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function pdf_discharge_summary(){
		$this->require_ipd_print_access('ipd_print_discharge_summary', 'pdf');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
	...
	public function print_services(){
		$this->require_ipd_print_access('ipd_print_services', 'browser');
			$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function pdf_services(){
		$this->require_ipd_print_access('ipd_print_services', 'pdf');
			$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
	...
	public function print_laboratory(){
		$this->require_ipd_print_access('ipd_print_laboratory', 'browser');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
		...
		if ($pilotSnapshotRead && $this->db->table_exists('iop_laboratory_release_snapshot') && $this->db->table_exists('iop_laboratory_release_batch')) {
			$q = $this->db->query(
	...
	public function pdf_laboratory(){
		$this->require_ipd_print_access('ipd_print_laboratory', 'pdf');
		$iop_no = $this->uri->segment("4");
		$patient_no = $this->uri->segment("5");
