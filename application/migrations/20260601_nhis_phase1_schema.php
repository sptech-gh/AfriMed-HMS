...
class Migration_Nhis_Phase1_Schema extends CI_Migration
{
    ...
    private function _extend_nhis_audit_log()
    {
        ...
        // Add user_id (numeric reference to HMS user)
        ...
        // Add action (alias/normalised action string)
        ...
        // Add batch_id (link to batch header where applicable)
        ...
        // Add visit_id (link to encounter/visit)
        ...
        // Add payload (structured JSON snapshot of the operation)
    ...
    {
        // nhis_ref_gdrg: add service_type (OUT/INP/DIA/CAP)
        ...
        // nhis_ref_medicines: add requires_lab_result flag
        ...
        // nhis_ref_tariffs: add service_type + facility_level
    ...
    private function _create_facility_credentials()
    {
        ...
        // Seed with the facility row provided in the specification
        $exists = $this->db
    ...
    private function _create_version_info()
    {
        ...
        // Seed the required versions, leaving XMLFormatVersion unset for now
