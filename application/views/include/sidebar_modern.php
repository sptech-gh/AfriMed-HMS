...
$isDoctor = has_role('doctor');
$isCashier = has_role('cashier');
$isPharmacist = has_role('pharmacist');

$__nurseOnlySidebar = ($isNurse && !$isAdmin && !$isDoctor && !$isCashier && !$isPharmacist && !$isReception && !$isLaboratory);
...
<aside class="left-side sidebar-offcanvas">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if ($hasAccesstoBilling || has_role(array('admin', 'cashier'))) { ?>
            <li class="quick-action">
                <a href="<?php echo base_url() ?>app/billing/smart_billing">
                    <i class="fa fa-file-text-o text-yellow"></i> <span>Create Bill</span>
                </a>
            </li>
            <li class="quick-action">
                <a href="<?php echo base_url() ?>app/ebilling/collect_payment">
                    <i class="fa fa-credit-card text-green"></i> <span>Collect Payment</span>
                </a>
            </li>
            <?php } ?>
            
            <?php if ((isset($hasAccesstoPharmacy) && $hasAccesstoPharmacy) || has_role('pharmacist')) { ?>
            <li class="quick-action">
            ...
            <!-- SECTION: CLINICAL -->
            <!-- ============================================== -->
            <?php if ($hasAccesstoOPDRegistration || $hasAccesstoOPDEnquiry || $hasAccesstoIPDRegistration || $hasAccesstoIPDEnquiry || $hasAccesstoAppointment) { ?>
            ...
            <!-- Imaging (Merged Sonography + Radiology) -->
            <?php if (
                (isset($hasAccesstoSonography) && $hasAccesstoSonography)
                || has_role(array('admin', 'doctor', 'sonographer', 'radiology', 'radiologist'))
                || has_privilege('radiology_access')
            ...
            <li class="treeview <?php echo ($currentTab === 'sonography' || $imagingActive) ? 'active' : ''; ?>">
                <a href="#">
                    <i class="fa fa-heartbeat"></i> <span>Imaging</span>
                    <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo base_url() ?>app/sonography/completed"><i class="fa fa-check-circle"></i> Completed Studies</a></li>
                    <?php if ($isAdmin) { ?>
            ...
            <!-- SECTION: PHARMACY -->
            <!-- ============================================== -->
            <?php if ((isset($hasAccesstoPharmacy) && $hasAccesstoPharmacy) || has_privilege('pharmacy_access')) { ?>
            ...
            <!-- ============================================== -->
            <?php if (has_role(array('admin', 'cashier', 'billing', 'accountant')) || $hasAccesstoBilling || has_privilege('billing_access')) { ?>
            <li class="header"><i class="fa fa-money"></i> BILLING & FINANCE</li>
            
            <!-- Billing -->
            <li class="treeview <?php echo ($currentTab === 'billing' || $currentTab === 'ebilling') ? 'active' : ''; ?>">
                <a href="#">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() ?>app/ebilling/collect_payment"><i class="fa fa-money text-green"></i> Collect Payment</a></li>
            ...
            <!-- ============================================== -->
            <!-- SECTION: REPORTS (Consolidated) -->
            <!-- ============================================== -->
            <?php if ($hasAccesstoReport || has_role(array('admin', 'doctor', 'nurse', 'receptionist', 'cashier'))) { ?>
            ...
            <li class="treeview <?php echo $reportsActive ? 'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if ($hasAccesstoReportDailySales && has_role('admin')) { ?>
            ...
            <li class="treeview <?php echo ($currentTab === 'patient') ? 'active' : ''; ?>">
                <a href="#">
                    <i class="fa fa-wheelchair"></i> <span>Patient Registry</span>
                    <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <?php if ($hasAccesstoAddPatient) { ?>
                    <li><a href="<?php echo base_url() ?>app/patient/addPatient"><i class="fa fa-plus-circle"></i> Add Patient</a></li>
                    <?php } ?>
                    <li><a href="<?php echo base_url() ?>app/patient/index"><i class="fa fa-list"></i> Patient List</a></li>
                    <li><a href="<?php echo base_url() ?>app/patient"><i class="fa fa-history"></i> Patient History</a></li>
                </ul>
            </li>
            <?php } ?>
            ...
            <?php } ?>
            <?php if ($hasAccesstoNurse && ($isNurse || $isDoctor || $isAdmin)) { ?>
            ...
            <li class="treeview <?php echo ($currentTab === 'nurse_module') ? 'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo base_url() ?>app/nurse_module/shift_tasks"><i class="fa fa-tasks"></i> Shift Tasks</a></li>
                </ul>
            </li>
            <?php } ?>
            ...
            <!-- Medicine Masters -->
            <?php if ($hasAccesstoAdminMedicineCategory || $hasAccesstoAdminDrugName) { ?>
            <li class="treeview <?php echo ($currentSubtab === 'medicine_master') ? 'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <?php } ?>
                    <?php if ($hasAccesstoAdminDrugName) { ?>
