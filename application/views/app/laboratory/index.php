        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1><?php echo isset($page_title) && $page_title ? $page_title : 'Labs'; ?></h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url()?>app/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                        <!-- <li><a href="#">Admin</a></li> -->
                        <li class="active"><?php echo isset($page_title) && $page_title ? $page_title : 'Labs'; ?></li>
                    </ol>
                </section>
                      ...
                      <div class="col-md-12">
                          <div class="box box-solid box-success">
                              <div class="box-header">
                                  <h3 class="box-title"><i class="fa fa-bell"></i> Cleared Patients — Awaiting Services</h3>
                              </div>
