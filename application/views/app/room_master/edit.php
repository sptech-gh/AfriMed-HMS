                 	...
                 	<div class="col-md-12">
                    	 ...
                    	 <div class="box">
                        	...
                        	<div class="box-body table-responsive">
                            	<?php if(empty($room_category)){ ?>
                            		<div class='alert alert-warning alert-dismissable'><i class='fa fa-warning'></i><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>Room Master record not found.</div>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Room Type</label>
                                            				<select name="roomType" id="roomType" class="form-control input-sm" style="width: 250px;" required>
																...
																if(isset($_POST['roomType']) && $_POST['roomType'] == $roomTypeList->category_id || $room_category->category_id == $roomTypeList->category_id){
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Floor</label>
                                            				<select name="floor" id="floor" class="form-control input-sm" style="width: 250px;" required>
																...
																if(isset($_POST['floor']) && $_POST['floor'] == $floorList->floor_id || $room_category->floor == $floorList->floor_id ){
																	$selected = "selected='selected'";
																}else{
																	$selected = "";
																}
