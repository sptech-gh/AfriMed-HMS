...
<head>
    <meta charset="UTF-8">
    <title>Laboratory Critical Alerts - Hebrew Medical Center</title>
    ...
    <style>
        ...
        .severity-panic { background: #dd4b39; color: #fff; }
        .severity-critical { background: #f39c12; color: #fff; }
        .severity-urgent { background: #00c0ef; color: #fff; }
        .result-critical { color: #dd4b39; font-weight: bold; font-size: 16px; }
...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            <section class="content-header">
                <h1><i class="fa fa-flask text-red"></i> Laboratory Critical Alerts</h1>
                <ol class="breadcrumb">
                    ...
                    <div class="col-md-12">
                        <div class="box box-danger">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-bell"></i> Pending Lab Critical Alerts (<?php echo count($alerts); ?>)</h3>
                            </div>
                            <div class="box-body table-responsive no-padding">
                                <?php if (empty($alerts)): ?>
                                    <div class="alert alert-success" style="margin: 15px;">
                                        <i class="fa fa-check-circle"></i> No pending laboratory critical alerts.
                                    </div>
                                <?php else: ?>
                                        ...
                                        <tbody>
                                            <?php $i = 1; foreach ($alerts as $alert): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($alert['test_name'] ?? 'N/A'); ?></td>
                                                    <td class="result-critical"><?php echo htmlspecialchars($alert['result_value'] ?? ''); ?></td>
                                                    <td><?php echo htmlspecialchars($alert['normal_range'] ?? '-'); ?></td>
                                                    <td><?php echo htmlspecialchars($alert['ordering_doctor_name'] ?? $alert['ordering_doctor'] ?? '-'); ?></td>
                                                    <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-green">
                    ...
                    <h4 class="modal-title"><i class="fa fa-check-circle"></i> Acknowledge Lab Critical Alert</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        <i class="fa fa-info-circle"></i> By acknowledging, you confirm review of this critical lab value.
                    </div>
                </div>
    ...
    <script>
        ...
        function submitAcknowledge() {
            ...
            $.post('<?php echo base_url();?>app/critical_alerts/acknowledge_lab', ackData, function(response) {
