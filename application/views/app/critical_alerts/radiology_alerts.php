...
<head>
    <meta charset="UTF-8">
    <title>Radiology Critical Findings - Hebrew Medical Center</title>
...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            <section class="content-header">
                <h1><i class="fa fa-x-ray text-red"></i> Radiology Critical Findings</h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="<?php echo base_url();?>app/critical_alerts/radiology_findings" class="btn btn-info" style="margin-bottom: 15px;">
                            <i class="fa fa-cog"></i> Manage Findings Definitions
                        </a>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="box box-danger">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-bell"></i> Pending Radiology Critical Alerts (<?php echo count($alerts); ?>)</h3>
                            </div>
                            <div class="box-body table-responsive no-padding">
                                <?php if (empty($alerts)): ?>
                                    <div class="alert alert-success" style="margin: 15px;">
                                        <i class="fa fa-check-circle"></i> No pending radiology critical findings.
                                    </div>
                                <?php else: ?>
                                        ...
                                        <tbody>
                                            <?php $i = 1; foreach ($alerts as $alert): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($alert['finding_name'] ?? 'N/A'); ?></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-green">
                    ...
                    <h4 class="modal-title"><i class="fa fa-check-circle"></i> Acknowledge Radiology Critical Finding</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        <i class="fa fa-info-circle"></i> By acknowledging, you confirm review of this critical radiology finding and appropriate clinical action.
                    </div>
                </div>
    ...
    <script>
        ...
        function submitAcknowledge() {
            ...
            $.post('<?php echo base_url();?>app/critical_alerts/acknowledge_radiology', ackData, function(response) {
