  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    ...
    <!-------------------------------------------------------------------->
        ...
        <body class="skin-blue" onLoad="getData()">
			...
			<?php
				// Defensive guard: keep view warning-free if opened without the expected context.
				$_ipd_patient = (isset($patientInfo) && is_object($patientInfo)) ? $patientInfo : null;
				if (!$_ipd_patient) {
					echo "<div style='padding:16px'><div class='alert alert-warning'><i class='fa fa-warning'></i> Please open this page from an In-Patient record (missing patient context).</div></div>";
					echo "</body></html>";
					return;
				}
			?>
