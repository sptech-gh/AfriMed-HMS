                                    ...
                                    <div class="box-tools">
                                        <div class="input-group">
                                            ...
                                            <tr>
												...
												<button class="btn btn-sm btn-default" type="button" id="btnToday">Today</button>
												<button class="btn btn-sm btn-default" type="button" id="btnLast7">Last 7 Days</button>
												<button class="btn btn-sm btn-default" type="button" id="btnThisMonth">This Month</button>
												<button class="btn btn-sm btn-warning" type="button" id="btnClear">Clear</button>
                                                </td>
                                            </tr>
                                            </table>
                                            </form>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
				...
				$('#btnToday').on('click', function(){
					var d = new Date();
					setRange(fmt(d), fmt(d));
				});
				$('#btnLast7').on('click', function(){
					var to = new Date();
					var from = new Date();
