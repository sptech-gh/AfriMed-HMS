                         ...
                         <div class="box">
                        	...
                        	<div class="box-body table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php $cur_ins_type = isset($insurance_companyList->insurance_type) ? $insurance_companyList->insurance_type : 'PRIVATE'; ?>
                                                <select name="insurance_type" id="insurance_type" class="form-control input-sm" style="width: 250px;" required onchange="autoMapBilling()">
                                                    ...
                                                    <option value="NHIS" <?php echo set_select('insurance_type','NHIS', $cur_ins_type==='NHIS'); ?>>NHIS</option>
                                                    <option value="PRIVATE" <?php echo set_select('insurance_type','PRIVATE', $cur_ins_type==='PRIVATE'); ?>>Private Insurance</option>
                                                    <option value="CORPORATE" <?php echo set_select('insurance_type','CORPORATE', $cur_ins_type==='CORPORATE'); ?>>Corporate / Company Cover</option>
                                                    <option value="NONE" <?php echo set_select('insurance_type','NONE', $cur_ins_type==='NONE'); ?>>None / Self-Pay</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <?php $cur_bill_type = isset($insurance_companyList->billing_type) ? $insurance_companyList->billing_type : 'PRIVATE_INSURANCE'; ?>
                                                <select name="billing_type" id="billing_type" class="form-control input-sm" style="width: 250px;" required>
                                                    <option value="">- Select Billing -</option>
                                                    <option value="CASH" <?php echo set_select('billing_type','CASH', $cur_bill_type==='CASH'); ?>>CASH</option>
                                                    <option value="NHIS" <?php echo set_select('billing_type','NHIS', $cur_bill_type==='NHIS'); ?>>NHIS</option>
                                                    <option value="PRIVATE_INSURANCE" <?php echo set_select('billing_type','PRIVATE_INSURANCE', $cur_bill_type==='PRIVATE_INSURANCE'); ?>>Private Insurance</option>
                                                    <option value="CORPORATE" <?php echo set_select('billing_type','CORPORATE', $cur_bill_type==='CORPORATE'); ?>>Corporate</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group" style="width: 250px;">
                                                    <?php $cur_pricing_pct = isset($insurance_companyList->pricing_percentage) ? $insurance_companyList->pricing_percentage : '0.00'; ?>
                                                    <?php echo form_input('pricing_percentage', set_value('pricing_percentage', $cur_pricing_pct), 'id="pricing_percentage" class="form-control input-sm" placeholder="0.00" step="0.01" style="text-align: right;"');?>
