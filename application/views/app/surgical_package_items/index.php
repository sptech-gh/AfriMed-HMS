                        	...
                        	<div class="box-body table-responsive no-padding">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
										<form method="post" action="<?php echo base_url()?>app/surgical_package/delete_item/<?php echo $surgery_items->m_id?>/<?php echo $surgery->surgery_id?>" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete?');">
