                 ...
                 <div class="row">
                            ...
                            <div class="box-footer clearfix">
                            	<div style="margin-top: 15px;">
                                 <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="<?php echo base_url()?>app/opd/discharge_summary/<?php echo url_safe_id($getOPDPatient->IO_ID);?>/<?php echo $getOPDPatient->patient_no;?>"> Discharge Summary</a></li>
                     ...
                     <div class="col-md-9"> 
                                <div class="nav-tabs-custom">
                                	...
                                	<td width="79%"><textarea name="reason_admission" id="reason_admission" class="form-control input-sm" style="width: 60%;" rows="3" <?php echo $canEditClinical ? '' : 'readonly'; ?>><?php echo $reason_admission?></textarea></td>
                                </tr>
                                <tr>
                                	<td valign="top">Condition Upon Discharge</td>
                                	<td>
                                    	<select name="condition" id="condition" class="form-control input-sm" style="width: 60%;" required <?php echo $canEditClinical ? '' : 'disabled'; ?>>
                                ...
                                <tr>
                                	...
                                	<td width="79%"><textarea name="admitting_impression" id="admitting_impression" class="form-control input-sm" style="width: 60%;" rows="3" <?php echo $canEditClinical ? '' : 'readonly'; ?>><?php echo $admitting_impression?></textarea></td>
                                </tr>
                                <tr>
                                	<td width="21%" valign="top">Final Diagnosis</td>
                                	<td width="79%"><textarea name="final_diagnosis" id="final_diagnosis" class="form-control input-sm" style="width: 60%;" rows="3" <?php echo $canEditClinical ? '' : 'readonly'; ?>><?php echo $final_diagnosis?></textarea></td>
                                </tr>
                                <tr>
                                	<td width="21%" valign="top">Clinical Findings</td>
                                	<td width="79%"><textarea name="physical_exam_findings" id="physical_exam_findings" class="form-control input-sm" style="width: 60%;" rows="3" <?php echo $canEditClinical ? '' : 'readonly'; ?>><?php echo $physical_exam_findings?></textarea></td>
                                </tr>
                                <tr>
                                	<td width="21%" valign="top">Course in the Ward</td>
                                	<td width="79%"><textarea name="course_ward" id="course_ward" class="form-control input-sm" style="width: 60%;" rows="3" <?php echo $canEditClinical ? '' : 'readonly'; ?>><?php echo $course_ward?></textarea></td>
                                </tr>
                                <tr>
                                           		<td colspan="2">
                                                ...
                                                <?php }}?>
                                                <a href="<?php echo base_url()?>app/ipd_print/print_discharge_summary/<?php echo url_safe_id($getOPDPatient->IO_ID);?>/<?php echo $getOPDPatient->patient_no;?>" class="btn btn-default" target="_blank"><i class="fa fa-print"></i> Print</a>
                                                <a href="<?php echo base_url()?>app/ipd_print/pdf_discharge_summary/<?php echo url_safe_id($getOPDPatient->IO_ID);?>/<?php echo $getOPDPatient->patient_no;?>" class="btn btn-success" target="_blank"><i class="fa fa-print"></i> PDF</a>
                                                </td>
                                           </tr>
                                           </tbody>
                                           </table>
