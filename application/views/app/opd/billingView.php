            ...
            <aside class="right-side">                
                ...
                <section class="content">
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-3">
                    	 <div class="box">
                        	...
                        	<div class="box-body table-responsive no-padding">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php
                                            $bv_nhis = isset($patientInfo->nhis_number) ? trim((string)$patientInfo->nhis_number) : '';
                                            $bv_nhis_st = isset($patientInfo->nhis_status) ? strtoupper(trim((string)$patientInfo->nhis_status)) : '';
                                            if ($bv_nhis !== ''):
                                        ?>
                                        <tr>
                                            <td>
                                                <?php if ($bv_nhis_st === 'ACTIVE'): ?>
                                                    <span class="label label-success"><i class="fa fa-check-circle"></i> NHIS Active</span>
                                                <?php elseif ($bv_nhis_st === 'EXPIRED'): ?>
                            ...
                            <div class="box-footer clearfix">
								...
								<?php if (function_exists('has_role') && has_role('cashier') && !has_role('admin')) { ?>
                     ...
                     <?php echo form_open('app/billing/update_invoice', array('onsubmit' => 'return validate_form()')); ?>
                     ...
                     <div class="col-md-9"> 
								...
								<?php endif; ?>
                                               ...
                                               <div class="form-group">
                                            		<label for="exampleInputEmail1">Date</label>
                                            		 <input type="text" value="<?php echo date("M d, Y", strtotime($headerInv->dDate));?>" name="invoice_date" id="invoice_date" class="form-control input-sm" style="width:250px;" readonly>
                                        		</div>
                                                ...
                                                <div class="form-group">
                                            		...
                                            		<select name="paymentType" id="paymentType" class="form-control input-sm" style="width:250px;" onChange="setTitle(this.value)">
                                                        ...
                                                        <option value="insurance" <?php if($headerInv->payment_type == "insurance"){ echo "selected";}?> <?php echo ($insCardSt === 'INACTIVE') ? 'disabled' : ''; ?>>Insurance Company</option>
                                                    </select>
                                        		</div>
                                           ...
                                           <div class="alt2" dir="ltr" style="
                                    		...
                                    		<tbody>
                                            	...
                                            	<tr>
                                                    ...
                                                    <td>
                                                        <input type="text" size="7" style="width:98%; background-color:#F9F9f9; border:1px solid #ccc;" name="bill_name<?php echo $num;?>" id="bill_name<?php echo $num;?>" value="<?php echo $detailsInv->bill_name?>" readonly="true">
                                                        <input type="hidden" name="source_module<?php echo $num;?>" id="source_module<?php echo $num;?>" value="<?php echo isset($detailsInv->source_module) ? htmlspecialchars((string)$detailsInv->source_module, ENT_QUOTES, 'UTF-8') : ''; ?>">
                                                        <input type="hidden" name="source_ref<?php echo $num;?>" id="source_ref<?php echo $num;?>" value="<?php echo isset($detailsInv->source_ref) ? htmlspecialchars((string)$detailsInv->source_ref, ENT_QUOTES, 'UTF-8') : ''; ?>">
                                                    </td>
                            ...
                            <div class="box-footer clearfix">
                                ...
                                <tr>
                                    ...
                                    <button class="btn btn-default" type="button" data-toggle="modal" data-target="#billableModal"><i class="fa fa-list"></i> Add Billable Items</button>
									...
									<?php if (isset($headerInv->receipt_no) && trim((string)$headerInv->receipt_no) !== '') { ?>
										<a href="<?php echo base_url()?>app/opd/printOR/<?php echo $getOPDPatient->IO_ID?>/<?php echo $patientInfo->patient_no?>/<?php echo $headerInv->invoice_no?>" class="btn btn-success" target="_blank"> <i class="fa fa-print"></i> Print Receipt</a>
										<a href="<?php echo base_url()?>app/opd/pdfOR/<?php echo $getOPDPatient->IO_ID?>/<?php echo $patientInfo->patient_no?>/<?php echo $headerInv->invoice_no?>" class="btn btn-info" target="_blank"> <i class="fa fa-file-pdf-o"></i> Receipt PDF</a>
									<?php } ?>
                                    </td>
                                    <td align="right">GROSS&nbsp;&nbsp;
                                    <input type="text" name="nGross" id="nGross" readonly style="width:100px;" value="<?php echo $headerInv->total_amount?>">
                                    <input type="hidden" name="total_amount" id="total_amount" value="<?php echo $headerInv->total_amount?>"></td>
                                </tr>
                                <?php
                                    $bv_payer = isset($headerInv->payer_type) ? strtoupper(trim((string)$headerInv->payer_type)) : 'CASH';
                                    $bv_nhis_cov = isset($headerInv->nhis_covered_amount) ? (float)$headerInv->nhis_covered_amount : 0;
                                    $bv_pat_pay = isset($headerInv->patient_payable_amount) ? (float)$headerInv->patient_payable_amount : 0;
                                ?>
                                <input type="hidden" name="payer_type" id="payer_type" value="<?php echo $bv_payer; ?>">
                                <?php if ($bv_payer === 'NHIS'): ?>
                                <tr>
                                    <td>
                                    ...
                                    <td align="right">
                                        ...
                                        <input type="text" name="nhis_covered_display" id="nhis_covered_display" readonly style="width:100px;background:#eafaf1;color:#27ae60;font-weight:bold;border:1px solid #27ae60;" value="<?php echo number_format($bv_nhis_cov, 2); ?>">
                                        &nbsp;&nbsp;
                                        <span style="color:#e74c3c;font-weight:bold;">Patient Pays:&nbsp;</span>
                                        <input type="text" name="patient_pays_display" id="patient_pays_display" readonly style="width:100px;background:#fdedec;color:#e74c3c;font-weight:bold;border:1px solid #e74c3c;" value="<?php echo number_format($bv_pat_pay, 2); ?>">
                                    </td>
                                </tr>
                                <?php endif; ?>
                                </table>
...
xmlhttp2.send();
						...
						<div class="modal fade" id="billableModal" tabindex="-1" role="dialog" aria-labelledby="billableModalLabel" aria-hidden="true">
							<div class="modal-dialog" style="width:800px;">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
										<h4 class="modal-title" id="billableModalLabel">Add Billable Items</h4>
									</div>
									<div class="modal-body">
										<?php if (isset($billable_items) && is_array($billable_items) && count($billable_items) > 0) { ?>
											<table class="table table-bordered table-striped">
												...
												<tbody>
													<?php foreach ($billable_items as $bi): ?>
														<?php
															$biName = isset($bi->drug_name) ? (string)$bi->drug_name : (isset($bi->particular_name) ? (string)$bi->particular_name : '');
															$biQty = isset($bi->total_qty) ? (float)$bi->total_qty : 1.0;
															$biRate = isset($bi->nPrice) ? (float)$bi->nPrice : 0.0;
															$biMod = isset($bi->source_module) ? (string)$bi->source_module : '';
															$biRef = isset($bi->source_ref) ? (string)$bi->source_ref : '';
														?>
														<tr>
															<td>
																<input type="checkbox" class="bi-check" data-name="<?php echo htmlspecialchars($biName, ENT_QUOTES, 'UTF-8'); ?>" data-qty="<?php echo number_format((float)$biQty, 2, '.', ''); ?>" data-rate="<?php echo number_format((float)$biRate, 2, '.', ''); ?>" data-mod="<?php echo htmlspecialchars($biMod, ENT_QUOTES, 'UTF-8'); ?>" data-ref="<?php echo htmlspecialchars($biRef, ENT_QUOTES, 'UTF-8'); ?>">
															</td>
															<td><?php echo htmlspecialchars($biMod, ENT_QUOTES, 'UTF-8'); ?></td>
															<td><?php echo htmlspecialchars($biName, ENT_QUOTES, 'UTF-8'); ?></td>
															<td class="text-right"><?php echo number_format((float)$biQty, 2); ?></td>
															<td class="text-right"><?php echo number_format((float)$biRate, 2); ?></td>
														</tr>
													<?php endforeach; ?>
												</tbody>
											</table>
										<?php } else { ?>
											<div class="alert alert-success">No pending billable items found.</div>
										<?php } ?>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
										<button type="button" class="btn btn-primary" onclick="return addSelectedBillables();">Add Selected</button>
									</div>
								</div>
							</div>
						</div>
						...
						<script type="text/javascript">
						function addSelectedBillables() {
							var checks = document.querySelectorAll('#billableModal .bi-check:checked');
							...
							for (var i = 0; i < checks.length; i++) {
								...
								appendInvoiceRow(
									...
									c.getAttribute('data-qty') || '1',
									c.getAttribute('data-rate') || '0',
									c.getAttribute('data-mod') || '',
									c.getAttribute('data-ref') || ''
								);
							}
							getGross();
							$('#billableModal').modal('hide');
							return false;
						}

						function appendInvoiceRow(name, qty, rate, srcMod, srcRef) {
							var tbl = document.getElementById('myTable');
							var cntEl = document.getElementById('hdnrowcnt');
							if (!tbl || !cntEl) return;
							var cnt = parseInt(cntEl.value || '0', 10);
							if (isNaN(cnt)) cnt = 0;
							var next = cnt + 1;

							var a = tbl.insertRow(-1);
							...
							b.innerHTML = '<input type="text" size="7" style="width:98%; background-color:#F9F9f9; border:1px solid #ccc; text-align:right" name="id' + next + '" id="id' + next + '" value="' + next + '. " readonly="true">';
							c.innerHTML = '<input type="text" size="7" style="width:98%; background-color:#F9F9f9; border:1px solid #ccc;" name="bill_name' + next + '" id="bill_name' + next + '" value="' + name + '" readonly="true">'
								+ '<input type="hidden" name="source_module' + next + '" id="source_module' + next + '" value="' + srcMod + '">' 
								+ '<input type="hidden" name="source_ref' + next + '" id="source_ref' + next + '" value="' + srcRef + '">';
							d.innerHTML = '<input type="text" size="7" style="width:98%; text-align:right" name="qty' + next + '" id="qty' + next + '" class="' + next + '" value="' + qty + '" onBlur="return validate_input(this.className,\'qty\')" onkeyup="validate_gross(this.className,\'qty\')" onkeypress="return isNumberKey(event)">';
							e.innerHTML = '<input type="text" size="7" style="width:98%; text-align:right" name="rate' + next + '" id="rate' + next + '" class="' + next + '" value="' + rate + '" onBlur="return validate_input(this.className,\'rate\')" onkeyup="validate_gross(this.className,\'rate\')" onkeypress="return isNumberKey(event)">';
							f.innerHTML = '<input type="text" size="7" style="width:98%; background-color:#F9F9f9; border:1px solid #ccc; text-align:right" name="amount' + next + '" id="amount' + next + '" value="0" readonly="true">';
							g.innerHTML = '<input type="text" size="7" style="width:98%;" name="note' + next + '" id="note' + next + '" value="">';
							h.innerHTML = '<img src="<?php echo base_url()?>public/img/b_drop.png" onclick="deleteRow(this)" style="cursor:pointer;">';

							cntEl.value = next;
							validate_gross(next, 'rate');
						}
						</script>
					...
					function deleteRow(r){
						...
						if (lastRow > 2) {
							...
							for (z=i+1; z<=lastRow; z++){
								...
								var source_module = document.getElementById('source_module' + z);
								var source_ref = document.getElementById('source_ref' + z);
								...
								if (source_module) {
									source_module.id = "source_module" + x;
									source_module.name = "source_module" + x;
								}
								if (source_ref) {
									source_ref.id = "source_ref" + x;
									source_ref.name = "source_ref" + x;
								}
