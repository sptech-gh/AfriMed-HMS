...
<head>
    <meta charset="UTF-8">
    <title><?php echo isset($companyInfo->site_title) ? $companyInfo->site_title : 'HMS'; ?> — Lab Test Catalog</title>
...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            <section class="content-header">
                <h1><i class="fa fa-flask"></i> Laboratory Test Catalog <small>GHS/NHIS Standard Tests</small></h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo base_url(); ?>app/dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                    <li class="active">Lab Test Catalog</li>
                </ol>
            </section>
            ...
            <section class="content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="info-box bg-aqua">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"><?php echo $stats['lab_total'] ?? 0; ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="info-box bg-green">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"><?php echo $stats['lab_active'] ?? 0; ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="info-box bg-yellow">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"><?php echo $stats['lab_nhis'] ?? 0; ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-list"></i> Laboratory Tests</h3>
                        <div class="box-tools">
                            <a href="<?php echo base_url(); ?>app/test_catalog/add_lab_test" class="btn btn-success btn-sm">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table id="labTestsTable" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        <th width="80">Code</th>
                                        <th>Test Name</th>
                                ...
                                <tbody>
                                    ...
                                    <tr data-category="<?php echo htmlspecialchars($test->category); ?>" 
                                        ...
                                        <td>
                                            ...
                                            <?php if (isset($test->requires_fasting) && $test->requires_fasting): ?>
                                            <br><small class="text-warning"><i class="fa fa-cutlery"></i> Fasting required</small>
                                            <?php endif; ?>
                                        </td>
                                        <td><span class="label label-default"><?php echo htmlspecialchars($test->category); ?></span></td>
                                        <td><?php echo htmlspecialchars($test->specimen_type ?? '-'); ?></td>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url(); ?>app/test_catalog/edit_lab_test/<?php echo $test->test_id; ?>" 
    ...
    $(document).ready(function() {
        ...
        $('.status-toggle').on('change', function() {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>app/test_catalog/toggle_lab_test',
                type: 'POST',
                data: postData,
                dataType: 'json',
