                     ...
                     <div class="col-md-9"> 
                                <div class="nav-tabs-custom">
                                	<ul class="nav nav-tabs">
                                		<li class="active"><a href="#tab_1" data-toggle="tab">Ward Services</a></li>
                                        
                                	</ul>
                                    <div class="tab-content">
                                    	<div class="tab-pane active" id="tab_1">
                                        	<?php echo $message;?>
                                            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Add Ward Service</a>
                                           ...
                                           <tr>
                                                ...
                                                <td>
                                                <form method="post" action="<?php echo base_url()?>app/nurse_module/delete_bed_side/<?php echo $getServices->bed_pro_id?>/<?php echo url_safe_id($getOPDPatient->IO_ID) ?>/<?php echo $getOPDPatient->patient_no?>" style="display:inline;" onsubmit="return confirm('Are you sure you want to remove?');">
...
xmlhttp.open("GET","<?php echo base_url();?>app/nurse_module/bed_side_item/"+category_id,true);
xmlhttp.send();
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Ward Service Request</h4>
                                        </div>
