                         		...
                         		<div class="box-body table-responsive">
                                    ...
                                    <div class="box-body">
                                        <div class="input-group">
											...
											<form method="post" action="<?php echo isset($form_action) ? $form_action : base_url().'app/nurse_module/'.$module; ?>" onSubmit="return nursePickValidate();">
